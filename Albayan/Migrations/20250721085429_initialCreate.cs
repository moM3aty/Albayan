        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookstoreName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EducationalMaterials_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EducationalMaterials_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemindersCount = table.Column<int>(type: "int", nullable: false),
                    TeacherId = table.Column<int>(type: "int", nullable: false),
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                    GradeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LiveLessons_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LiveLessons_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LiveLessons_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "MaterialSalesOutlets",
                columns: table => new
                {
                    AvailableMaterialsId = table.Column<int>(type: "int", nullable: false),
                    SalesOutletsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialSalesOutlets", x => new { x.AvailableMaterialsId, x.SalesOutletsId });
                    table.ForeignKey(
                        name: "FK_MaterialSalesOutlets_EducationalMaterials_AvailableMaterialsId",
                        column: x => x.AvailableMaterialsId,
                        principalTable: "EducationalMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaterialSalesOutlets_SalesOutlets_SalesOutletsId",
                        column: x => x.SalesOutletsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradePercentage = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "LiveLessonReminders",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    LiveLessonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveLessonReminders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveLessonReminders_LiveLessons_LiveLessonId",
                        column: x => x.LiveLessonId,
                        principalTable: "LiveLessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LiveLessonReminders_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EducationalMaterials_GradeId",
                table: "EducationalMaterials",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationalMaterials_SubjectId",
                table: "EducationalMaterials",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LiveLessonReminders_LiveLessonId",
                table: "LiveLessonReminders",
                column: "LiveLessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveLessonReminders_StudentId",
                table: "LiveLessonReminders",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveLessons_GradeId",
                table: "LiveLessons",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveLessons_SubjectId",
                table: "LiveLessons",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveLessons_TeacherId",
                table: "LiveLessons",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialSalesOutlets_SalesOutletsId",
                table: "MaterialSalesOutlets",
                column: "SalesOutletsId");
